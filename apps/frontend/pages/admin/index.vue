    ...
    <div id="main-wrapper">
      ...
      <div class="nav-header">
        <a href="index.html" class="brand-logo">
          <img class="logo-abbr" src="/assets/admin/imageslogo.png" alt="" />
          <img class="logo-compact" src="/assets/admin/imageslogo-text.png" alt="" />
          <img class="brand-title" src="/assets/admin/imageslogo-text.png" alt="" />
        </a>
                ...
                <div class="card-header chat-list-header text-center">
                  ...
                  <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right">
                      ...
                      <li class="dropdown-item">
                        <i class="fa fa-users text-primary mr-2"></i> Add to
                        close friends
                      </li>
                      <li class="dropdown-item">
                        <i class="fa fa-plus text-primary mr-2"></i> Add to
                        group
                      </li>
                      <li class="dropdown-item">
                  ...
                  >
                    ...
                    <div class="header-info">
                      <span class="text-black"
                        ><strong>Peter Parkur</strong></span
                      >
                          ...
                          <div class="card text-center">
                            <div class="card-body">
                              ...
                              <h5 class="fs-16 font-w500 mb-1">
                                <a href="app-profile.html" class="text-black"
                                  >Roberto Carloz</a
                                >
                              </h5>
                ...
                <div class="col-xl-12">
                  <div class="card featuredMenu">
                    <div class="card-header border-0">
                      <h4 class="text-black font-w600 fs-20 mb-0">
                        Featured Diet Menu
                      </h4>
                    </div>
                    <div
                    ...
                    >
                      <div class="media mb-4">
                        ...
                        <div class="media-body">
                          <h5>
                            <a href="food-menu.html" class="text-black fs-16"
                              >Chinese Orange Fruit With Avocado Salad</a
                            >
                          </h5>
                      ...
                      >
                        <li class="mr-3 mb-2">
                          <i class="las la-clock scale5 mr-3"></i
                          ><span class="fs-14 text-black">4-6 mins </span>
                        </li>
                        <li class="mb-2">
                          <i
                      ...
                      <div class="media mb-4">
                        ...
                        <div class="media-body">
                          <h5>
                            <a href="food-menu.html" class="text-black fs-16"
                              >Fresh or Frozen (No Sugar Added) Fruits</a
                            >
                          </h5>
                          <span class="fs-14 text-primary font-w500"
                      ...
                      <div class="media mb-4">
                        ...
                        <div class="media-body">
                          <h5>
                            <a href="food-menu.html" class="text-black fs-16"
                              >Original Boiled Egg with Himalaya Salt</a
                            >
                          </h5>
                          <span class="fs-14 text-primary font-w500"
                            >Peter Parkur</span
